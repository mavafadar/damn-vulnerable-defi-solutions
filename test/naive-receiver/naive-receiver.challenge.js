...
describe("[Challenge] Naive receiver", function () {
  ...
  it("Execution", async function () {
    ...
    const naiveReceiverSolutionFactory = await ethers.getContractFactory(
      "NaiveReceiverSolution",
      player
    );
    const naiveReceiverSolutionContract =
      await naiveReceiverSolutionFactory.deploy(pool.address, receiver.address);
    const txResponse = await naiveReceiverSolutionContract.solveChallenge();
