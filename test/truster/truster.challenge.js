...
describe("[Challenge] Truster", function () {
  ...
  it("Execution", async function () {
    ...
    trusterLenderPoolSolutionContract = await (
      await ethers.getContractFactory("TrusterLenderPoolSolution", player)
    ).deploy(pool.address);
    const txResponse = await trusterLenderPoolSolutionContract.solveChallenge();
    txResponse.wait(1);
  });
